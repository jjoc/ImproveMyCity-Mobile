...
//    private final String TAG = getClass().getName();
   ...
   protected void onClick() {
	    ...
	    // 1 select
	    builder.setPositiveButton(FActivity_TabHost.resources.getString(R.string.Proceed),
...
//    			editor.putString("UserNameAR" , " ");
//    			editor.putString("emailAR" , " ");
//    			editor.putString("PasswordAR" , " ");
//    			editor.putString("UserRealName" , " ");
//	    		editor.commit();

	    		Toast.makeText(ctx, FActivity_TabHost.resources.getString(R.string.Deleted), Toast.LENGTH_LONG).show();
	    		Toast.makeText(ctx, FActivity_TabHost.resources.getString(R.string.Restartneed), Toast.LENGTH_LONG).show();
...
//	    		PendingIntent intent = PendingIntent.getActivity(ctx, 0, i, i.getFlags());
