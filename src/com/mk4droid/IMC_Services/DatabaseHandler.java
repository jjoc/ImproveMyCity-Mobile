...
public class DatabaseHandler extends SQLiteOpenHelper {
     ...
     * @return
     */
	public int AddUpdUserVotes(String UserNameSTR, String PasswordSTR){
	 ...
	 */
	public int addUpdIssues(double CurrLong, double CurrLat, int distance, int IssuesNo){
    	...
    	try {
			...
			{   
				...
				for (int i=0; i<NCateg; i++){
					...
					// Download icon
				    byte[] CategIcon = Download_Data.Down_Image(
          			              Constants_API.COM_Protocol + Constants_API.ServerSTR + 
	...
	public VersionDB getCategVersion() {
		...
		VersionDB mVersionDB = new VersionDB(0,"not avail yet");
