...
public class Upload_Data {
    ...
    public static boolean SendVote(int UserID, int IssueID, String UserNameSTR, String PasswordSTR){
    	...
    	String result =  Download_Data.RestCaller(
    			Constants_API.COM_Protocol + Constants_API.ServerSTR + Constants_API.phpExec , RestClient.RequestMethod.GET, 
    			                 new String[]{
    ...
    // ------------------------ SendComment ------------------
    public static boolean SendComment(int IssueID, int UserID, String CommentContent, Context ctx,
    		                          String username, String password){
    	
    	String result =  Download_Data.RestCaller(
    			Constants_API.COM_Protocol + Constants_API.ServerSTR + Constants_API.phpExec, RestClient.RequestMethod.GET, 
    			     new String[]{"option",      "com_improvemycity",
    					          "task",        Phptasks.TASK_COMMENT,
    					          "format",      "json",
    					          "issueId",     Integer.toString(IssueID),
			                      "userid",      Integer.toString(UserID),
			                      "description", CommentContent,
			                      "username", username,
			                      "password", Security.EncWrapper(password)}, "UTF-8");
