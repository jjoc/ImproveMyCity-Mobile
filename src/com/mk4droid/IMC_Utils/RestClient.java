    ...
    public String Execute(RequestMethod method)
    {
        switch(method) {
            case GET:
            {
                ...
                //Log.e("urlcombinedParams", urlcombinedParams);
...
//    	Log.e("IIclient ", "A =" +  (String) client.getParams().getParameter(CoreProtocolPNames.HTTP_CONTENT_CHARSET));
//        Log.e("IIIIIII", "A =" +  (String) request.getParams().getParameter(CoreProtocolPNames.HTTP_CONTENT_CHARSET));
